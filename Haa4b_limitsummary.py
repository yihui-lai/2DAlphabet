...
# Input files
file_pattern = "higgsCombine.testAsymptoticLimits.ma_30.leptonic.toy*.AsymptoticLimits.mH120.root"
data_file = "data.root"
...
c.SaveAs("limit_distribution_with_data_arrow.png")
