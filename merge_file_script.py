...
if CAT_OUT == 'XXHi':
  ...
  for cat in CAT_INS:
      CATS_IN[cat] = {}
  CATS_IN['WlvHi']['dir']   = '/afs/cern.ch/user/h/hboucham/public/2D_Alphabet_Inputs/2D_1L_021125_noGenBcut/'
  CATS_IN['WlvHi']['sigs']  = ['WHtoaato4b']
  CATS_IN['ttbblv']['dir']  = '/afs/cern.ch/user/h/hboucham/public/2D_Alphabet_Inputs/2D_1L_021125_noGenBcut/'
  CATS_IN['ttbblv']['sigs'] = ['ttHtoaato4b']
  CATS_IN['ttbll']['dir']   = '/afs/cern.ch/user/h/hboucham/public/2D_Alphabet_Inputs/2D_2Ltt_021125_noGenBcut/'
  CATS_IN['ttbll']['sigs']  = ['ttHtoaato4b']
  CATS_IN['Zll']['dir']     = '/afs/cern.ch/user/h/hboucham/public/2D_Alphabet_Inputs/2D_2LZ_021125_noGenBcut/'
  ...
  for cat in CAT_INS:
     CATS_IN[cat] = {}
  CATS_IN['WlvLo']['dir']   = '/afs/cern.ch/user/h/hboucham/public/2D_Alphabet_Inputs/2D_1L_021125_noGenBcut/'
  CATS_IN['WlvLo']['sigs']  = ['WHtoaato4b']
  CATS_IN['ttblv']['dir']  = '/afs/cern.ch/user/h/hboucham/public/2D_Alphabet_Inputs/2D_1L_021125_noGenBcut/'
